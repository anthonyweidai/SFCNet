...
class Opts(object):
    def __init__(self):
        ...
        self.Parser.add_argument("--task", default="segmentation", help="segmentation")
        self.Parser.add_argument("--sup_method", type=str, default="common", help="common")
        ...
        self.Parser.add_argument("--fg_bottle_se", type=int, default=1,
                                help="0 none | 1 squeeze and excitation ")
        ...
        self.Parser.add_argument("--det_loss_name", type=str, default=None)
        self.Parser.add_argument("--insseg_loss_name", type=str, default=None)
        self.Parser.add_argument("--reg_loss_name", type=str, default="mse")
